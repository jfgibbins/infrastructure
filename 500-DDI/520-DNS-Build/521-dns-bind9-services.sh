#!/bin/bash
# File: 521-dns-bind9-services.sh
# Title: Service tmp.d and default startup settings for Bind9
# Description:
#   Drop two new systemd unit files:
#      {named/bind9}.service
#      {named@/bind9@}.service
#   Add a conflict to any existing 'bind.service' to our unit files
...
#   - RNDC_CONF - rndc configuration file - not used here
#   - INSTANCE - Bind9 instance name, if any - not used here
#
...
ExecStart=/usr/sbin/named -u $USER_NAME -c \$NAMED_CONF
...
# systemd 'Type=simple' hardcoded this '-f'  #### this has been removed...I like to fork as often as possible
...
echo "Refreshing systemctl daemon-reload"
...
# Instantiation-specific settings:
BIND_EOF
flex_chown "root:root" "$FILESPEC"
flex_chmod "0644"      "$FILESPEC"
